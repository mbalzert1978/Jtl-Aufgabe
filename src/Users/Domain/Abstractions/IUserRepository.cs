...
public interface IUserRepository
{
    ...
    /// </returns>
    Task<Result<User, string>> GetByIdAsync(Guid id, CancellationToken cancellationToken = default);
    ...
    /// </remarks>
    Task<Result<Unit, string>> AddAsync(User user, CancellationToken cancellationToken = default);
}
